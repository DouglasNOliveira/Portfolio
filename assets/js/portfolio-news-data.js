/*
 * Cadastro de notícias. Para adicionar uma publicação, copie um item abaixo.
 * `publishedOn` usa somente a data no formato AAAA-MM-DD.
 */
window.portfolioNews = [
  {
    category: "Publicação", title: "TCE-PR destaca painel sobre investimento municipal nos ODS",
    summary: "Painel apresenta como os 399 municípios paranaenses destinam recursos aos Objetivos de Desenvolvimento Sustentável.",
    body: ["A publicação apresenta o painel criado para tornar a leitura dos investimentos municipais nos 17 ODS mais clara e acessível.", "A visualização organiza dados dos dois últimos ciclos do PPA e apoia o acompanhamento social das prioridades orçamentárias no Paraná.", "A iniciativa reforça a importância de conectar planejamento público, transparência e indicadores que possam ser consultados por diferentes públicos."],
    publishedOn: "2026-07-22", author: "Douglas Nascimento de Oliveira, Robson Fernandes Soares", images: ["assets/news_img/MateriaPublicadaTCEPR.png"], link: "https://www1.tce.pr.gov.br/noticias/painel-identifica-investimento-em-ods-no-orcamento-dos-399-municipios-do-parana.htm", linkLabel: "Ler publicação"
  },
  {
    category: "Power BI", title: "Orçamento Municipal nos ODS", summary: "Dashboard para identificar a parcela do orçamento municipal destinada aos objetivos definidos pela ONU.",
    body: ["O dashboard traduz informações orçamentárias em uma leitura direta sobre a destinação de recursos aos ODS.", "Filtros e comparações permitem explorar o cenário estadual e evidenciar prioridades de planejamento.", "A estrutura visual prioriza perguntas práticas: quais objetivos recebem recursos, como os municípios se comparam e onde estão as principais concentrações de investimento."],
    publishedOn: "2026-08-05", author: "Douglas Nascimento de Oliveira, Robson Fernandes Soares", images: ["assets/news_img/DashboardOrcamentoODS.png"], link: "https://app.powerbi.com/view?r=eyJrIjoiNzI1M2RkZTYtMmFjOS00ZWVkLTgyODktZWM4ZTRiN2Q0ZTdmIiwidCI6ImY3MGEwYWY2LWRhMGYtNDViZS1iN2VkLTlmOGMxYjI0YmZkZiIsImMiOjR9", linkLabel: "Abrir dashboard"
  },
  {
  ...
  },
  {
    ...
    body: ["O portal reúne calculadoras para apoiar a avaliação de objetos de licitação pública.", "Modelos físico-matemáticos projetam fluxos de caixa ao longo do ciclo de vida do objeto.", "Além da interface de consulta, a solução busca tornar premissas e resultados de cálculo mais compreensíveis para quem acompanha processos de aquisição pública."],
    publishedOn: "2025-08-05", author: "Douglas Nascimento de Oliveira", images: ["assets/news_img/PortalCalculadorasTCEPR.png"], link: "https://douglasnoliveira.github.io/portal-calculadoras/", linkLabel: "Acessar ferramenta"
  },
  {
